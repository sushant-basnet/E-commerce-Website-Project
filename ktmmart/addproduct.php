...
<br>
<center>
<form action="cartconfig/submitpro.php" method="post" class="box" enctype="multipart/form-data">
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
    echo "<tr><th>".$row['productid']."</th> <th>".$row['name']."</th> <th>".$row['type']."</th> <th>".$row['price']."</th> <th>".$row['imgloca']."</th> <th>".$row['sub']."</th></tr>";
  }
  echo "</table>";
} else {
  echo "0 results";
